...
class BNInception_STFT(nn.Module):
    def __init__(self, model_path='tf_model_zoo/bninception/bn_inception_stft.yaml', num_classes=101,
                       weight_url='https://yjxiong.blob.core.windows.net/models/bn_inception-9f5701afb96c8044.pth'):
        super(BNInception_STFT, self).__init__()
