...
# python main.py mydataset RGB Flow --config ./exps/myicarl.json \
# --train_list mydataset_train.txt --val_list mydataset_test.txt \
# --arch BNInception --num_segments 8 --dropout 0.5 --epochs 50 -b 8 \
# --lr 0.001 --lr_steps 10 20 --gd 20 --partialbn  -j 8 \
# --pretrained_flow ./pretrain_model/TSN-kinetics-flow.pth --flow_prefix flow_ 

python main.py mydataset RGB Flow STFT STFT_2 --config ./exps/myicarl.json --train_list mydataset_train.txt --val_list mydataset_test.txt --mpu_path '/home/amax/Downloads/whx/temporal-binding-network/dataset/gyro/' --arch BNInception --num_segments 8 --dropout 0.0  --epochs 10 -b 8 --lr 0.001 --lr_steps 30 --gd 50 --partialbn -j 8 --pretrained_flow ./pretrain_model/TSN-kinetics-flow.pth
#python main.py mydataset RGB Flow STFT STFT_2 --config ./exps/myfinetune.json --train_list mydataset_train.txt --val_list mydataset_test.txt --mpu_path '/home/amax/Downloads/whx/temporal-binding-network/dataset/gyro/' --arch BNInception --num_segments 8 --dropout 0.5 --epochs 10 -b 8 --lr 0.0001 --lr_steps 50 --gd 20 --partialbn -j 8 --pretrained_flow ./pretrain_model/TSN-kinetics-flow.pth