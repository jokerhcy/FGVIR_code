                ...
                for i in range(proto_features.shape[0]):
                    for j in range(8):
                      if len(self._modality) > 1:   
                        ...
                        proto_time[i,j,:1024] = proto_features[i,:1024] + np.random.normal(0,1,proto_features[i,:1024].shape)*self.rgb_radius*2
                        proto_time[i,j,1024:2048] = proto_features[i,1024:2048] + np.random.normal(0,1,proto_features[i,1024:2048].shape)*self.flow_radius*1
                        proto_time[i,j,2048:3072] = proto_features[i,2048:3072] + np.random.normal(0,1,proto_features[i,2048:3072].shape)*self.acc_radius*1
                        proto_time[i,j,3072:4096] = proto_features[i,3072:4096] + np.random.normal(0,1,proto_features[i,3072:4096].shape)*self.gyro_radius*1
                      else:
                        proto_time[i,j,:] = proto_features[i] + np.random.normal(0,1,proto_features[i].shape)*self._radius*2
