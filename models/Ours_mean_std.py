...
##################################################################################
                ...
                index = np.random.choice(range(self._known_classes),size= self._batch_size * 2*int(self._known_classes/(self._total_classes-self._known_classes)),replace=True)
                    ...
                    for j in range(8):
                        for dim in range(1024*len(self._modality)):
                          if len(self._modality) > 1:   
                            proto_time[i,j,dim] = proto_features[i,dim] + np.random.normal(0,1,proto_features[i,dim].shape) * std_features[i,dim] * 2
                          else:
